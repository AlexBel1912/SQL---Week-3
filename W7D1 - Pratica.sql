...
SELECT dimproduct.EnglishProductName AS NomeProdotto, SUM(factresellersales.SalesAmount) AS FatturatoTotale, SUM(factresellersales.OrderQuantity) AS QuantitaTotaleVenduta, AVG(factresellersales.UnitPrice) AS PrezzoMedioDiVendita, dimproduct.ProductKey
	FROM factresellersales 
